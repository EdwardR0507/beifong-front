  ...
  return (
    <div className="w-full px-3 mb-3">
      ...
      <div className="relative">
        <textarea
          className="block w-full px-4 py-3 mt-2 text-base leading-tight text-gray-700 transition rounded appearance-none h-80 dark:bg-gray-600 ring-gray-300 ring-2 focus:ring-sky-400 dark:ring-gray-400 focus:outline-none focus:bg-white dark:focus:ring-sky-600 dark:focus:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-400"
          id={name}
          type={typeInput}
          name={name}
